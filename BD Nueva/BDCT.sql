...
CREATE TABLE IF NOT EXISTS `pct3`.`factura_cabina` (
  ...
  INDEX `fk_factura_cabina_empresa1_idx` (`empresa_empresa_id` ASC),
  ...
  CONSTRAINT `fk_factura_cabina_colaborador1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_factura_cabina_empresa1`
...
CREATE TABLE IF NOT EXISTS `pct3`.`gasto_operativo` (
  ...
  INDEX `fk_gasto_operativo_persona1_idx` (`persona_idpersona` ASC),
  CONSTRAINT `fk_gasto_operativo_persona1`
    FOREIGN KEY (`persona_idpersona`)
    REFERENCES `pct3`.`persona` (`idpersona`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
