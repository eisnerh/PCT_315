...
CREATE TABLE IF NOT EXISTS `pct3`.`factura_cabina` (
  ...
  INDEX `fk_factura_cabina_persona2_idx` (`persona_idpersona` ASC),
...
CREATE TABLE IF NOT EXISTS `pct3`.`puesto` (
  ...
  INDEX `fk_puesto_colaborador1_idx` (`colaborador_empleado_id` ASC),
  CONSTRAINT `fk_puesto_colaborador1`
    FOREIGN KEY (`colaborador_empleado_id`)
    REFERENCES `pct3`.`colaborador` (`empleado_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
