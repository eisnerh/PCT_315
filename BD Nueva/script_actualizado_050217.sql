...
CREATE TABLE IF NOT EXISTS `PCT2`.`facturar_cabina` (
  ...
  INDEX `fk_facturar_cabina_cabina1_idx` (`cabina_cabina_id` ASC),
  INDEX `fk_facturar_cabina_empleado1_idx` (`empleado_empleado_id` ASC),
  CONSTRAINT `fk_facturar_cabina_cabina1`
    FOREIGN KEY (`cabina_cabina_id`)
    REFERENCES `PCT2`.`cabina` (`cabina_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_facturar_cabina_empleado1`
...
CREATE TABLE IF NOT EXISTS `PCT2`.`cliente` (
  ...
  INDEX `fk_cliente_facturar_cabina1_idx` (`facturar_cabina_factura_id` ASC),
  ...
  CONSTRAINT `fk_cliente_empleado1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_cliente_facturar_cabina1`
