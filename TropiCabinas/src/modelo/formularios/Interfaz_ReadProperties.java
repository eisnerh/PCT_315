...
public class Interfaz_ReadProperties {
    ...
    public Interfaz_ReadProperties(java.net.URL path) throws IOException {
        this.ruta = path;
        init();
    }
    ...
    private void init() throws IOException {
        try {
            ...
            System.err.println("Traza: " + Arrays.toString(ex.getStackTrace()));
            throw ex;
        }
    }
